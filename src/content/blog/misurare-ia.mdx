...
summary: "Il 60% dei manager ammette di aver bisogno di KPI migliori per l'AI. Nel frattempo, i dati che davvero contano esistono già — ma nessuno li sta guardando."
...
copy:
  ...
  thesis: "Misuriamo le cose sbagliate: attività invece di impatto"
  hook:
    type: "quantified-paradox"
    content: "Il 60% dei manager ammette di aver bisogno di KPI migliori, ma il 42% sta abbandonando i progetti AI. Se misuriamo così tanto, perché falliamo così spesso?"
  takeaways:
    - "Segmenta l'impatto per ruolo/seniority, non usare medie aggregate"
    - "Distingui uso sostitutivo da uso augmentativo dell'AI"
    - "Usa gruppi di controllo e baseline, non confronti prima/dopo"
    - "Monitora con dashboard ad alta frequenza, non review trimestrali"
  memorable_phrases:
    - term: "metriche di vanità"
      definition: "Numeri che crescono facilmente ma non dicono nulla sull'impatto reale sul business"
    - term: "paradosso dell'apprendistato"
      definition: "Le aziende smettono di assumere junior perché l'AI fa quei task, ma senza junior oggi non avranno senior domani"
  cta:
    type: "newsletter"
...
# SEO ADVANCED
# ═══════════════════════════════════════════════════════════════
meta_title: "Metriche AI Enterprise: Perché il 42% dei Progetti Fallisce"
focus_keyword: "metriche AI enterprise"
...
# ═══════════════════════════════════════════════════════════════
og:
  title: "Il 60% dei Manager Vuole KPI Migliori per l'AI. Stanford Mostra Quali."
  description: "La ricerca Stanford rivela perché i progetti AI falliscono e come misurare correttamente l'impatto"
  image: "/images/covers/misurare-ia.png"
  image_alt: "Grafico che mostra tassi di fallimento AI vs qualità della misurazione"

# ═══════════════════════════════════════════════════════════════
# TWITTER CARD CUSTOMIZATION
# ═══════════════════════════════════════════════════════════════
twitter:
  title: "Stai Misurando l'AI nel Modo Sbagliato. Stanford Mostra Come Farlo"
  description: "Il 42% dei progetti AI fallisce. Il problema: metriche di vanità. La soluzione: misurazione differenziale."

# ═══════════════════════════════════════════════════════════════
# SCHEMA.ORG FAQ
# ═══════════════════════════════════════════════════════════════
faq:
  - question: "Perché i progetti AI falliscono nonostante dashboard dettagliate?"
    answer: "Le aziende misurano attività (ore risparmiate, task automatizzati) invece di impatto (valore business, effetti differenziali per ruolo). Le metriche aggregate nascondono redistribuzione critica tra seniority e ruoli."
  - question: "Quali metriche AI usare invece del tempo risparmiato?"
    answer: "Segmentare impatto per ruolo e seniority, distinguere uso sostitutivo da augmentativo, usare gruppi di controllo invece di confronti prima/dopo, monitorare con dashboard ad alta frequenza invece di review trimestrali."
  - question: "Come misurare l'impatto AI sui team junior vs senior?"
    answer: "Secondo la ricerca Stanford su 25 milioni di lavoratori, l'impatto AI è radicalmente diverso per fascia d'età: sviluppatori 22-25 anni hanno visto calo occupazionale del 20%, over-35 crescita dell'8%. Serve segmentazione demografica nelle dashboard."
...
promo:
  summary:
    short: "Il 60% dei manager vuole KPI migliori per l'AI. La ricerca Stanford mostra come fare."
    medium: "I progetti AI falliscono al 42% nonostante si misuri tutto. Il problema: metriche di vanità. Stanford mostra cosa misurare invece."
    long: "La tua dashboard AI mostra ore risparmiate e task automatizzati. Ma il 42% dei progetti fallisce comunque. Perché? Misuriamo attività invece di impatto. La ricerca Stanford su 25 milioni di lavoratori rivela cosa funziona davvero."

  social:
    linkedin: |
      La maggior parte delle dashboard AI ti sta mentendo.
      
      Non con numeri falsi, con numeri veri che non contano.
      ...
      Nel frattempo:
      - 42% dei progetti AI abbandonati
      - 95% non genera ROI misurabile
      - Il tasso di fallimento è raddoppiato in un anno
      
      Il problema? Misuriamo attività, non impatto.
      
      Erik Brynjolfsson di Stanford ha analizzato 25 milioni di lavoratori. I risultati sono chiari.
      
      Analisi completa sul blog.

    twitter: |
      Le tue metriche AI sono probabilmente sbagliate.
      
      Tracci ore risparmiate e task automatizzati.
      
      Ma il 42% dei progetti AI fallisce comunque.
      
      Perché? Misuri attività, non impatto.
      
      La ricerca Stanford mostra cosa misurare invece.

    bluesky: "Hot take: La maggior parte della misurazione AI è teatro. Le aziende tracciano deployment mentre i progetti falliscono. Brynjolfsson ha analizzato 25M lavoratori: Junior dev -20%, Senior dev +8%. La media? Zero. Misurare medie nasconde redistribuzione."

  newsletter:
    subject: "Stai misurando l'AI sbagliato (e ti sta costando)"
    preview: "La ricerca Stanford rivela perché il 42% dei progetti AI fallisce nonostante metriche perfette..."
    intro: "Questa settimana: Perché la tua dashboard AI mente, cosa rivela lo studio Stanford su 25 milioni di lavoratori, e il framework di misurazione che funziona davvero."
...
editorial:
  ...
  review_notes: "v1.2: Corretto pillar (business invece di methodology), aggiunto TL;DR, migliorato SEO titles, riviste FAQ, proofreading completo."
  changelog:
    - date: "2025-12-20"
      version: "1.0"
    ...
    - date: "2025-12-27"
      version: "1.1"
      changes: "Aggiunta sezione FAQ, aggiornate statistiche fallimento, migliorato copy LinkedIn basato su engagement"
    - date: "2025-12-29"
      version: "1.2"
      changes: "Corretto pillar da methodology a business, aggiunto TL;DR, rivisti meta titles, FAQ più actionable, proofreading stilistico"
  content_type: "analysis"

# ═══════════════════════════════════════════════════════════════
# MEDIA & STATUS
# ═══════════════════════════════════════════════════════════════
coverImage: "/images/covers/misurare-ia.png"
featured: false
draft: false
